...
- Make package is explicitly marked DRAFT and specifies module 10 TED key preparation, the module 11 delivery sink, the module 12 completion barrier, explicit module 14/16 cursor writes, and account-gated retry tests for both TED key families.
...
5. Build the Make scenario, run all error-path tests including the module 11 post-commit timeout/failure proof that module 12/module 14 do not run and the cursor remains unchanged, export it from Make, and perform a fresh-account import.
